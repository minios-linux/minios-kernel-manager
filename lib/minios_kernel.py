...
def package_kernel(args):
    ...
    try:
        ...
        temp_dir = get_temp_dir_with_space_check(600, "kernel_packaging_")
        ...
        generate_initramfs(kernel_version, args.init_comp, args.output, logger=None, temp_dir=temp_dir)
    ...
    if args.json:
        ...
        for kernel in available_kernels:
            ...
            kernels_json.append({
                "version": kernel,
                "is_active": is_active,
                "is_running": False,  # TODO: implement running detection
...
def main():
    ...
    package_parser.add_argument("--init-comp", default="zstd", help=_("Compression method for initramfs"))
